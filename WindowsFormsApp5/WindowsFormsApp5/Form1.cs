...
namespace WindowsFormsApp5
{
    public partial class Form1 : Form
    {
        ...
        private void comfont_SelectedIndexsChanged(object sender, EventArgs e)
        {
            ChangeFont();
        }
        ...
        private void chkItalic_CheckChanged(object sender, EventArgs e)
        {
            ChangeFont();
        }
        ...
        private void rdoTkd_CheckChanged(object sender, EventArgs e)
        {
